...
*/
		...
		ArrayList<CompraDecision> test1 = ProcesadorDeListas.getInstancia().procesarLista_PrecioDistancia_MonoLocal(lc, locales, -34.6167f, -58.3817f, 2f);
		...
		ArrayList<CompraDecision> test2 = ProcesadorDeListas.getInstancia().procesarLista_PrecioDistancia_MultiLocal(lc, locales, -34.6167f, -58.3817f, 2f);

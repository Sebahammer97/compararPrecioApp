...
public class ProcesadorDeListas
{
	...
	public ArrayList<CompraDecision> procesarListaMejorPrecioMonoLocal(final Lista listaCompra, final List<Local> locales)
	{
		...
		boolean [][] matrizTengo = this.crearMatrizTengo(listaCompra, locales, cantidadLocales, cantidadProductos, localesPreguntar, productosPreguntar);
	...
	public ArrayList<CompraDecision> procesarListaMejorPrecioOptimo(final Lista listaCompra, final List<Local> locales)
	{
		//----------||Recolección de datos||------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
		...
		boolean [][] matrizMejor = this.crearMatrizMejor(listaCompra, locales, cantidadLocales, cantidadProductos, localesPreguntar, productosPreguntar); 
